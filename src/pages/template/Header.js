    ...
    return (
      <div className="menu-header">
        <div className="menu-header-left">
          <img
            onClick={(e) => this.toogle(e)}
            className="burger-menu pull-left"
            src={imgBurger}
          />
          <div className="menu-header-date-wrapper pull-left">
            ...
            <div className="menu-header-date">{this.state.date}</div>
          </div>
        </div>
        ...
        <div className="menu-header-right pull-right col-md-4">
          <div className="pull-right">
            ...
            />
            <img
              className="message-icon pull-left"
              src={this.state.hasNotif ? imgMessageNotif : imgMessage}
            />
            <div
              className="pp-icon pull-left"
              style={{ backgroundImage: 'url("' + imgPP + '")' }}
            />
